...
span {display:block;} .ftr-cl-rgt {text-align:center;}
 ...
 <div class="container" style="text-align:center">
  <div class="jumbotron">
         <p align="center"><h2>Acesso restrito</h2><br><p class="text-muted"><h3>Por favor, identifique-se</h3></p></p></div>
        ...
        <br>
        <p align="center" style="font-size:8px;">Powered by <img src="Principal/znt/img/znt1.png" width="5%" heigth="5%"></p>
